...
$bootstrap = @($result.Policies | Where-Object { $_.BasePolicyID -eq $basePolicyIdText -and $_.FriendlyName -eq $friendlyName -and $_.IsOnDisk -eq $true -and $_.IsEnforced -eq $true -and $_.IsAuthorized -eq $true })
...
[ordered]@{ result='PASS'; base_policy_id=$basePolicyIdText; supplemental_policy_id=$bootstrap[0].PolicyID; candidate_harness='V10.6.4' } | ConvertTo-Json -Compress
