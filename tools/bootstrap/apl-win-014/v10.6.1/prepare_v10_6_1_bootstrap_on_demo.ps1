...
$PolicyFriendlyName = 'Arvectum APL-WIN-014 Harness V10.6.1 Bootstrap'
...
Write-Host ''
Write-Host '=== V10.6.1 Bootstrap hash rules ==='
...
$evidence = New-Object PSObject -Property @{
    schema = 'arvectum.proxy.apl-win-014-v10.6.1-bootstrap-authoring.v1'
    task = 'APL-WIN-014'
